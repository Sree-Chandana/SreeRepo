...
public class SN_newRecord extends SN_openURL {
	// get id
	public SN_newRecord getGId() throws InterruptedException {
	...
	public SN_newRecord enterCallerName(String callerName) throws InterruptedException {
		// driver.switchTo().frame(0);
		Thread.sleep(10000);
	...
	public SN_newRecord enterShrtDes(String des) throws InterruptedException {
		Thread.sleep(10000);
